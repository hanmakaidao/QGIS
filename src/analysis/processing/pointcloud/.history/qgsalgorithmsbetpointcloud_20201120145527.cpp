...
Qgis::DataType QgsPointCloudGeoRefWithSbetAlgorithm::getRasterDataType( int typeId )
{
  switch ( typeId )
  {
    case 0:
...
bool QgsPointCloudGeoRefWithSbetAlgorithm::prepareRandomParameters( const QVariantMap &parameters, QgsProcessingContext &context )
{
