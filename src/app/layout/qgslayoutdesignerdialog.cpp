  ...
  , mToolsActionGroup( new QActionGroup( this ) )
{
  ...
  mMenuView->setObjectName( QStringLiteral( "mViewMenu" ) );
  connect(mMenuView, &QMenu::aboutToShow, this, &QgsLayoutDesignerDialog::populateLayoutsMenu );
...
{
  QgisApp::instance()->populateLayoutsMenu(mMenuView);
}
